...
!(function () {
  ...
  -1 < navigator.platform.indexOf("Win") &&
    ...
    document.getElementsByClassName("fixed-plugin")[0] &&
      ...
      new PerfectScrollbar(t)),
    document.getElementsByClassName("memo-plugin")[0] &&
      ((t = document.querySelector(".memo-plugin")), 
      new PerfectScrollbar(t))
      );
})(),
...
0 != document.querySelectorAll(".input-group").length &&
  ...
  document.querySelector(".memo-plugin") &&
    ((memoPlugin = document.querySelector(".memo-plugin")),
    (memoPlugin = document.querySelector(".memo-plugin")),
    (memoPluginButton = document.querySelector(".memo-plugin-button")),
    (memoPluginButtonNav = document.querySelector(".memo-plugin-button-nav")),
    (memoPluginCard = document.querySelector(".memo-plugin .card")),
    (memoPluginCloseButton = document.querySelectorAll(
      ".memo-plugin-close-button"
    )),
    (navbar = document.getElementById("navbarBlur")),
    (buttonNavbarFixed = document.getElementById("navbarFixed")),
    memoPluginButton &&
      (memoPluginButton.onclick = function () {
        memoPlugin.classList.contains("show")
    ...
    memoPluginCloseButton.forEach(function (e) {
      e.onclick = function () {
        memoPlugin.classList.remove("show");
      };
    }),
    (document.querySelector("body").onclick = function (e) {
      e.target != memoPluginButton &&
        e.target != memoPluginButtonNav &&
        e.target.closest(".memo-plugin .card") != memoPluginCard &&
        memoPlugin.classList.remove("show");
    }),
    navbar &&
      "true" == navbar.getAttribute("data-scroll") &&
